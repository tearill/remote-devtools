...
module.exports = class Server {
    constructor(options) {
        ...
        this.use(homeMiddleware(path.join(this.root, '../public/home.html')));
    ...
    setupHttps() {
        if (this.options.https) {
            ...
            if (!this.options.https.key || !this.options.https.cert) {
                // 传递当前的 https 配置和服务器地址给 getCertificate
                const serverConfig = {
                    ...this.options.https,
            ...
            this.options.https.key = this.options.https.key || fakeCert.key;
            this.options.https.cert = this.options.https.cert || fakeCert.cert;
        }
    }
    createServer() {
        if (this._server) {
